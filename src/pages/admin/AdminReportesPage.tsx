...
const AdminReportesPage = () => {
  ...
  const handleVer = async (id: string) => {
    try {
      ...
      console.debug('[AdminReportesPage] usuarioId del reporte:', r.usuarioId, '| en mapa:', r.usuarioId in usuariosMap);
  ...
  const reportesFiltrados = useMemo(() => reportes.filter(r => {
    ...
    return true;
  }), [reportes, busqueda, filtroTipo, filtroEstado, filtroEspecie]);
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between mt-1.5">
                          ...
                          {r.direccionReferencia && (
                            <span className="flex items-center gap-0.5 text-xs text-slate-400 truncate ml-2">
